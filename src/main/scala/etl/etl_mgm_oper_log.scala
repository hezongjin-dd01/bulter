...
object etl_mgm_oper_log {
  ...
  //没用到
  def getDataframe(spark: SparkSession, url: String, table: String, user: String, password: String) = {

    val prop = new Properties()
    prop.put("user", user)
    prop.put("passwor", password)
